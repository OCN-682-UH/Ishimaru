...
In this document we will be practicing writing functions. We will be creating two function to help us optimize our data analysis and plotting goals.  
...
#### Functions
This first function will clean the data and calculate the mean and standard deviation for a given variable. Obtaining the mean and standard deviation will provide useful columns for plotting!
```{r}
...
Finally, lets use our plotting function to create figures based on our two test data sets!
```{r HW_plot1}
